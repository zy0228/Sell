<template>
  <div class="goods">
    <div class="menu-warppwer" ref="menuWrapper">
      <ul>
        <li v-for="(item,index) in goods" :key="index" class="menu-item" :class="{'current':currentIndex===index}" @click="selectMenu(index,$event)" ref="menuList">
          <span class="text border-1px">
            <span class="icon" v-show="item.type>0" :class="classMap[item.type]"></span>{{goods[index].name}}
          </span>
        </li>
      </ul>
    </div>
    <div class="goods-warpper" ref="foodsWrapper">
      <ul>
          ...
          <ul>
            <li @click="selectFood(foods,$event)" v-for="(foods,index) in item.foods" :key="index" class="food-item border-1px">
              ...
              <div class="goods-content">
                ...
                <div class="extra">
                  <span>月销{{foods.sellCount}}份</span>
                ...
                <div class="cartcontrol-wrapper">
                  <cartcontrol @add="addFood" :food="foods"></cartcontrol>
                </div>
              </div>
            </li>
          </ul>
